    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#btnTagSelect").on("click", function () {
                window.open("getTag.aspx?enabled=N", "_blank", "width=250px,height=350px");
            });
            ...
            <table border="1" width="100%" cellpadding="5">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        ||
                        新增主分類<asp:TextBox ID="tbNewCategory" runat="server" ToolTip="空值則套用下拉選項"></asp:TextBox>
                        /
                        新增次分類<asp:TextBox ID="tbNewSubCategory" runat="server" ToolTip="空值則套用下拉選項"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="tbTag" Width="80%" ReadOnly="false" runat="server"></asp:TextBox>
