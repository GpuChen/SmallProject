...
public partial class SAI_Knowledge_Manager : System.Web.UI.Page
{
    ...
    protected void btnInfomationSafe_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("./SAI_Knowledge_Manager.aspx?category=資訊安全");
        DBINIT();
    }
    protected void btnInstall_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("./SAI_Knowledge_Manager.aspx?category=軟體安裝及操作");
        DBINIT();
    }
    ...
    protected void btnSAP_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("./SAI_Knowledge_Manager.aspx?category=SAP/ERP系統");
        DBINIT();
    }
    ...
    protected void btnOffice_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("./SAI_Knowledge_Manager.aspx?category=文書處理");
        DBINIT();
    }
    ...
    protected void btnBPM_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("./SAI_Knowledge_Manager.aspx?category=BPM");
        DBINIT();
    }
    protected void btnEngineSortWare_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("./SAI_Knowledge_Manager.aspx?category=工程軟體");
        DBINIT();
    }
