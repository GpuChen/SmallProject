...
<head runat="server">
    ...
    <script>
        ...
        $(function () {
            $("#tbFuzzySearching").on("click", function () {
                var table = document.getElementById("cbFuzzySearching");
    ...
    <form id="form1" runat="server" defaultbutton="btnSearch" autocomplete="on">
        <div>
                        ...
                        <table tabindex="1" border="0" width="100%" style="background-color: #000099; color: #FF0000;">
                            ...
                            <tr>
                                <td width="25%">
                                    ...
                                    <asp:DropDownList ID="ddlCategory" runat="server" Height="20px" Width="100%" AutoPostBack="true"
                                        OnTextChanged="ddlCategory_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td width="25%">
                                    <asp:Label ID="Label4" runat="server" Text="次分類查詢: "></asp:Label><br />
                                    <asp:DropDownList ID="ddlSubCategory" runat="server" Height="20px" Width="100%"></asp:DropDownList>
                                </td>
                                <td width="15%">
                                    <label>日期排序</label><br />
            ...
            <table border="1" width="100%">
                <td width="25%">
                    <asp:Label ID="Label2" runat="server" Text="主旨查詢:"></asp:Label><br />
                    <asp:DropDownList ID="ddlSearchTitle" runat="server" width="20%">
                        <asp:ListItem>Like</asp:ListItem>
                        <asp:ListItem>=</asp:ListItem>
                        <asp:ListItem><></asp:ListItem>
                    </asp:DropDownList>
                    <asp:TextBox ID="tbTitle" placeholder="替代軟體放置路徑" width="70%" runat="server"></asp:TextBox>
                </td>
                <td width="25%">
                    <asp:Label ID="Label3" runat="server" Text="關鍵字查詢:"></asp:Label>
                    <asp:Button ID="btnTagDialog" runat="server" Width="80px" Text="選單選取" OnClientClick="return false;" UseSubmitBehavior="false" /><br />
                    <asp:TextBox ID="tbTag" placeholder="EMAIL,代理人" ToolTip="使用逗號區隔" Width="100%" runat="server"></asp:TextBox>
                </td>
                <td>
                    <label>啟用狀態</label><br />
                ...
                <td style="text-align: center">
                    <asp:Button ID="btnSearch" runat="server" Text="搜尋" Width="80px" OnClick="btnSearch_Click" UseSubmitBehavior="true" OnClientClick="if (!checkEvent()) return false;" />
                        ...
                        <asp:Button ID="btnExport" runat="server" Text="匯出資料" Width="80px" OnClick="btnExport_Click" />
                </td>
                <tr>
                    <td colspan="4">
                        <label>日期查詢</label>
